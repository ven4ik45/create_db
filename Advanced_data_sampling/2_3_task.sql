...
where date_release between '01/01/2018' and '12/31/2020';
...
select track_name  from tracks t 
where track_name ilike any (array['my %', '% my', '% my %', 'my']);
...
where a.date_release between '01/01/2019' and '12/31/2020'
...
where a.date_release between '01/01/2020' and '12/31/2020');
